...
@Component({
  selector: 'app-sans-reserve-susp',
  standalone: true,
  imports: [
    AgGridAngular,
    CommonModule,
  ...
  templateUrl: './sans-reserve-susp.component.html',
  styleUrl: './sans-reserve-susp.component.scss'
})
export class SansReserveSuspComponent implements OnInit {
  dossiers: any[] = [];
      ...
      cellRenderer: (params: ICellRendererParams) => {
        ...
        return params.value
          .map((dec: any) => {
            ...
            return `<span style="color: orange; font-weight: bold;">${decisionText}</span>`;
          })
          .join("<br>");
      },
      minWidth: 80,
  ...
  ngOnInit(): void {
    this.getDossiersWithVisaSansReserveSusp();
  }
...
getEtatTextColorStyle(params: any): any {
  ...
  getDossiersWithVisaSansReserveSusp(): void {
    this.isLoading = true;
