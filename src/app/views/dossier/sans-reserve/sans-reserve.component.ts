...
@Component({
  ...
  templateUrl: './sans-reserve.component.html',
  styleUrl: './sans-reserve.component.scss'
})
export class SansReserveComponent implements OnInit {
  dossiers: any[] = [];
  isLoading: boolean = true;
  errorMessage: string | null = null;

  columnDefs: ColDef[] = [
    { headerName: "Numéro Dossier", field: "numeroDossier", sortable: true, filter: true, minWidth: 80},
    { headerName: "Intitulé", field: "intitule", sortable: true, filter: true, minWidth: 80  },
    {
      headerName: "État",
      field: "etat",
      sortable: true,
    ...
    { headerName: "Type Passation", field: "typePassation", sortable: true, filter: true, minWidth: 80  },
    { headerName: "Ajouté par", field: "chargeDossierName", sortable: true, filter: true, minWidth: 80  },
    {
      ...
      cellRenderer: (params: ICellRendererParams) => {
        ...
        return params.value
          .map((dec: any) => {
            ...
            return `<span style="color: green; font-weight: bold;">${decisionText}</span>`;
          })
          .join("<br>");
      },
      minWidth: 80,
  ...
  ngOnInit(): void {
    this.getDossiersWithVisaSansReserve();
  }
  ...
  getDossiersWithVisaSansReserve(): void {
    this.isLoading = true;
